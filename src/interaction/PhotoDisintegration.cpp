...
double PhotoDisintegration::getLambdaSum(Candidate candidate) {
...
double PhotoDisintegration::interpolate(size_t start, double x) {
	// bin below
...
void PhotoDisintegration::disintegrate(Candidate *candidate,
	...
	int dA = nNeutron + nProton + 2 * nDeuterium + 3 * nTritium + 3 * nHelium3
			+ 4 * nHelium4;
