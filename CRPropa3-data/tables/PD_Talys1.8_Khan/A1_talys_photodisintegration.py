...
# Create file of incident photon energies: 0.2 - 200 MeV in steps of dlogE = 0.01
eps = logspace(log10(0.2), log10(200), 301)
savetxt('eps.txt', eps, fmt='%.6g')
fname_eps = os.getcwd() + '/eps.txt'  # absolute path to eps.txt


# Run TALYS for each isotope (Z <= 26, A <= 30, lifetime > 2s)
# Note: TALYS cannot simulate H, He as targets
