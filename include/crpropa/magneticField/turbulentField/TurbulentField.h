...
private:
  ...
  const double sIndex; /**< Spectral index for the inertial range, for example s=5/3
                    for Kolmogorov spectrum */
  const double qIndex; /**< Spectral index for the injection range, for example q=4
...
public:
  TurbulenceSpectrum(double Brms, double lMin, double lMax, double lBendover = 1,
			double sIndex = 5. / 3., double qIndex = 4)
