 ...
 * Propagation module comparison ([notebook](propagation_comparison/Propagation Comparison (CK - BP).ipynb))([py](propagation_comparison/Propagation Comparison (CK - BP).py))
