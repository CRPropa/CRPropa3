...
TEST(testSPHMagneticField, construction) {
	SPHMagneticField(Vector3d(120, 120, 120) * Mpc, 8 * Mpc, 64, "/home/walz/software/mpc/data/mhd_z.db");
}

//TEST(testSPHMagneticFieldGrid, construction) {
//	SPHMagneticFieldGrid(Vector3d(120, 120, 120) * Mpc, 8 * Mpc, 8, "/home/walz/software/mpc/data/mhd1.db");
//}
